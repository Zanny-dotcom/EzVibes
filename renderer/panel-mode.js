(function () {
  ...
  const PANEL_REGIONS = new Map([
    ...
    ['command-bar', { name: 'Command bar', file: 'renderer/index.html', line: '42-48', describe: 'Strip above the folder grid: Launch Claude Here button, inbox button, ACTIVATE button, New Folder button, and item count.' }],
    ...
    ['new-folder-btn', { name: 'New Folder button', file: 'renderer/index.html', line: '46', describe: 'Button that starts a draft folder name field; the folder is created only after a valid name is entered.' }],
    ['folder-count', { name: 'Folder count', file: 'renderer/index.html', line: '47', describe: 'Text showing the number of items in the current folder.' }],
